      ...
      <div className="flex gap-3">
        {[
          ...
          <a
            ...
            className="w-[42px] h-[42px] rounded-xl border border-white/10 bg-white/5 flex items-center justify-center text-white transition-all hover:bg-white/10 hover:border-white/20 hover:-translate-y-0.5"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
